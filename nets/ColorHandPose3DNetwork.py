...
class ColorHandPose3DNetwork(object):
    """ Red que realiza la estimación de pose en 3D de una mano humana a partir de una imagen a color. """
    def __init__(self):
        self.crop_size = 256
        self.num_kp = 21
    ...
    def inference(self, image, hand_side, evaluation):
        ...
        """
        # utilizar la red para la segmentación de manos para la detección
